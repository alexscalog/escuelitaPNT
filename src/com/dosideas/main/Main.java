 ...
 *
 * Crear un programa cuyo punto de entrada sea un main en donde, al ejecutarse, se visualiza lo siguiente por consola
 ...
 *
 *
 * @version 	1.0 20 abril 2022
 * @author Alexandro Calogerópulos
 * 
 */
package com.dosideas.main;

import com.dosideas.Servicios.ProductoServicios;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=============================\n");
        servicio.visualizarCaro();
        servicio.visualizarBarato();
